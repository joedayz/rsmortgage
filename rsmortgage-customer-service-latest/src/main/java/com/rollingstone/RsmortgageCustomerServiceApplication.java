...
@EnableFeignClients
public class RsmortgageCustomerServiceApplication {

	static Class applicationClass = RsmortgageCustomerServiceApplication.class;
	private static final Logger log = LoggerFactory.getLogger(applicationClass);
	
	public static void main(String[] args) {
		SpringApplication.run(RsmortgageCustomerServiceApplication.class, args);
	}
}
